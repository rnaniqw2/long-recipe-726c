...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/taurusimagine
```

A live public deployment of this template is available at [https://taurusimagine.templates.workers.dev](https://taurusimagine.templates.workers.dev)
